	...
	return (
		<div className=" py-3 px-8">
			...
			<div className=" md:grid grid-cols-3">
				<main className=" col-span-2 md:border-r-2  md:px10 pr-8">
					<div className="flex  items-center py-6 pr-2 flex-wrap">
						<input
						...
						{category.map((category) => {
							return (
								<button className=" text-sm delay-75 mt-2 mx-2 flex f bg-gray-100 hover:bg-gray-200 rounded-xl font-sans py-[0.35rem] px-4">
									{category}
								</button>
							);
						})}
					...
					<div className="flex justify-between flex-wrap items-center mb-5 ">
						<h2 className=" font-medium text-gray-500 font-sans text">
							Articles
						</h2>
						<select
							...
							<div className=" border-t my-5">
								<div className="flex flex-row mt-3 mb-2 justify-self-center items-center">
									<img
										...
										alt=""
									/>
									<div className="flex flex-col text-xs text-gray-400 font-sans ml-2">
										<div className="flex">
				...
				<main className=" grid-cols-2 col-span-1 mb-8 ">
					<div className=" fixed">
						...
						<section className="flex justify-center flex-col py-6 px-8">
							<h2 className=" text-gray-900 font-medium mb-4 text-center">More interesting topics</h2>
							<div className=" flex justify-between gap-4 flex-wrap">
								{articles.map((article) => {
									return <button className=" border border-blue-300 hover:border-gray-300 hover:bg-gray-300 rounded-xl px-3 py-[0.15rem] ">{article.category}</button>;
								})}
							</div>
						</section>
					</div>
