...
const Dropdown = () => {
	return (
		<div class="relative inline-block text-left">
			<button class="bg-blue-500 text-white py-2 px-4 rounded inline-flex items-center">
				Dropdown
				<svg
					class="w-4 h-4 ml-2"
			...
			<ul class="hidden absolute left-0 mt-2 py-2 bg-white border border-gray-300 rounded-lg shadow-lg">
				<li>
					<a
						href="#"
